        ...
        if (ignoreCreateExceptions) {
            ...
            try {
                ...
                if (log.isDebugEnabled()) {
                    log.debug("[FactoryCreateRule]{" + digester.match +
                ...
                if (log.isInfoEnabled()) {
                    log.info("[FactoryCreateRule] Create exception ignored: " +
        ...
        if (
            ...
            if ((exceptionIgnoredStack.pop()).booleanValue()) {
                ...
                if (log.isTraceEnabled()) {
                    log.trace("[FactoryCreateRule] No creation so no push so no pop");
                }
                return;
            }
        }
